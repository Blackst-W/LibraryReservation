...
//            WatchAppDelegate.shared.transfer(reservation: reservation)
    ...
    private override init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(receiveReservationUpdate(notification:)), name: .ReceiveReservationUpdate, object: nil)
    }
    ...
    @objc func receiveReservationUpdate(notification: Notification) {
        reservation = notification.object as? SeatReservation
        save()
    }
